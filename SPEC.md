...
| 항목           | 값                                                                                                                                                                                                                            |
| -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 구성           | 앱 이름, 정지 버튼, 남은 시간, 진행 막대, 아이콘. 배치는 피그마 「Live Activity · 잠금화면」                                                                                                                                  |
| 집중 타이머    | 타는 모닥불 아이콘(`fireA` 프레임). 텍스트와 진행 막대는 `DESIGN.md` §2의 집중 색                                                                                                                                             |
| 휴식 타이머    | 꺼진 모닥불 아이콘(`fireCold` 프레임). 텍스트와 진행 막대는 `DESIGN.md` §2의 휴식 색                                                                                                                                          |
| 조작           | 정지 버튼. 앱의 정지와 같다. 앱이 백그라운드에 있거나 닫혀 있으면 Swift(App Intent)가 알림 취소·Live Activity 종료·정지됨 플래그 저장을 하고, 앱이 다음에 실행되거나 포그라운드로 올 때 플래그를 보고 타이머 세션 값을 지운다 |
